  ...
  return (
    <>
      ...
      <div className="flex min-h-screen lg:items-center max-lg:mx-10 max-lg:flex-col">
        ...
        />
        <div className="flex flex-col lg:basis-1/2 max-lg:items-center max-sm:items-start lg:items-start max-lg:basis-5/6">
          <p className="font-black text-5xl mb-14">Share your thoughts</p>
          <p className="font-black text-3xl mb-7">Join today.</p>

          <Button color="primary" className="w-1/2 font-semibold max-sm:w-full">
            <Link
              to="/newuser"
